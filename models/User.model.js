...
const seedUser=()=>{
    const qasem = new userModel({
        ...
        books:[{
            nameBook:'go to hell ',
            status:'https://images-na.ssl-images-amazon.com/images/I/51PSBrilewL._SX331_BO1,204,203,200_.jpg',
        ...
        status:'https://m.media-amazon.com/images/I/41BenSunWqL.jpg',
    ...
    // 2nd user 
    const ahamd=new userModel({
        email:'anofal719@gamil.com',
        books:[{
            nameBook:'one night in moon  ',
            status:'https://m.media-amazon.com/images/M/MV5BMjA0NjMxMTE0Nl5BMl5BanBnXkFtZTcwNzMwOTI0MQ@@._V1_SY264_CR6,0,178,264_AL_.jpg',
    ...
    status:'https://media.bloomsbury.com/rep/bj/9781526630377.jpg',
